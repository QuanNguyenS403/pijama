...
export default function OrdersHistoryDrawer({ isOpen, onClose }) {
  ...
  const [statusFilter, setStatusFilter] = useState('ALL') // 'ALL', 'AWAITING_PAYMENT', 'PENDING'
      ...
      {isOpen && (
        <>
          ...
          <motion.aside
            ...
            className="fixed inset-y-0 right-0 z-50 w-full max-w-[540px] bg-[#FAF8F5] shadow-2xl flex flex-col border-l border-[#E8DFD5]"
              ...
              <div className="flex items-center gap-3 relative z-10">
                ...
                <div>
                  ...
                  <p className="text-[11px] text-white/70 font-light">
                    Lịch sử đặt hàng & theo dõi tình trạng đơn
                  </p>
                </div>
              </div>
              ...
              {orders.length === 0 ? (
                ...
                <div className="flex flex-col items-center justify-center text-center py-16 px-4">
                  ...
                  <p className="text-xs text-[#8C7E74] max-w-xs mb-6 font-light leading-relaxed">
                    Khi bạn đặt hàng tại QuanNguyenS, toàn bộ thông tin đơn hàng và mã VietQR sẽ được lưu tại đây để bạn tiện theo dõi.
                  </p>
                  <button
                    onClick={onClose}
                ...
                filteredOrders.map((order) => {
                  ...
                  return (
                    <div
                      key={order.orderId}
                      className="bg-white rounded-[4px] border border-[#E8DFD5] shadow-xs overflow-hidden transition-all hover:border-[#D4AF37]/50"
                    >
                      {/* Order Header Bar */}
                        ...
                        <div>
                          {isVietQR ? (
                            <span className="inline-flex items-center gap-1 bg-[#E8F0FE] text-[#1967D2] text-[11px] font-bold px-2.5 py-1 rounded-[2px] border border-[#AECBFA]">
                              ...
                              Chờ chuyển khoản (Giảm 10%)
                            </span>
                          ) : (
                            <span className="inline-flex items-center gap-1 bg-[#FFF8E1] text-[#F57F17] text-[11px] font-bold px-2.5 py-1 rounded-[2px] border border-[#FFE082]">
                      ...
                      {isVietQR && (
                        <div className="p-3.5 sm:p-4 bg-[#FAF5F0] border-t border-[#E8DFD5]">
                          <button
                            ...
                            className="w-full flex items-center justify-between text-xs font-bold text-[#631521] hover:text-[#4A0D17] transition-colors"
                          >
                                ...
                                <div className="flex flex-col sm:flex-row items-center gap-4 bg-white p-3.5 rounded-[3px] border border-[#E8DFD5]">
                                  ...
                                  <div className="space-y-1.5 text-xs text-[#1A1614] flex-1 w-full">
                                    ...
                                    <p className="text-[10px] text-[#8C7E74] italic">
                                      * Nội dung chuyển khoản: Tên + SĐT của bạn
                                    </p>
                                  </div>
                                </div>
                              </motion.div>
                      ...
                      {/* Card Footer Assistance */}
                      <div className="px-3.5 py-2.5 bg-white border-t border-[#E8DFD5] flex items-center justify-between text-[11px] text-[#8C7E74]">
                        <span className="flex items-center gap-1">
                          <ShieldCheck className="w-3.5 h-3.5 text-[#631521]" />
                          Cam kết giao đúng mẫu & size
                        </span>
                        <a
                          href="tel:0981753082"
