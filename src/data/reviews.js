...
export const reviews = [
  {
    ...
    quote: 'Tôi rất hài lòng với bộ pajamas này: vải vừa mát lại mềm, mặc cả đêm cũng không bị nóng. Đây là lần đầu tôi ngủ ngon đến thế trong mùa hè oi ả Hanoi.',
    name: 'Lan H.',
    location: 'Hà Nội',
  ...
  },
  {
    ...
    quote: 'Từ khi có đồ ngủ đũi 10PM, tôi ngủ ngon hơn hẳn! Vải giặt đi giặt lại vẫn bền, càng dùng càng thấy mềm mại thích mê. Combo 2 bộ thực sự rất đáng tiền.',
    name: 'Thảo V.',
